...
public class GenericBukkitMessagesProvider implements BukkitMessagesProvider {
  ...
  public @NonNull String invalidLong(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid long", string);
  }

  @Override
  public @NonNull String invalidInteger(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid integer", string);
  }

  @Override
  public @NonNull String invalidDouble(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid double", string);
  }

  @Override
  public @NonNull String invalidBoolean(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid boolean", string);
  }

  @Override
  public @NonNull String invalidDuration(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not valid time", string);
  }
  ...
  public @NonNull String missingArgument(
    ...
    return GenericBukkitMessagesProvider.ERROR_PREFIX
  ...
  public String invalidPlayer(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid player", string);
  }

  @NonNull
  @Override
  public String playersOnly(@NonNull CommandContext context) {
    return GenericBukkitMessagesProvider.ERROR_PREFIX + "&c&oConsole cannot use this command";
  }
  ...
  public @NonNull String invalidMaterialEmpty(@NonNull CommandContext context) {
    return GenericBukkitMessagesProvider.ERROR_PREFIX + "&c&oMaterial cannot be empty";
  }

  @Override
  public @NonNull String invalidMaterial(@NonNull String string, @NonNull CommandContext context) {
    return Strings.format(
        GenericBukkitMessagesProvider.ERROR_PREFIX + "&4&o{0} &c&ois not a valid material", string);
  }
}
