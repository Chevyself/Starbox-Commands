...
public class CommandManager implements ICommandManager {
  ...
  public void registerCommand(@NotNull Object object) {
    ...
    for (final Method method : clazz.getDeclaredMethods()) {
      if (method.isAnnotationPresent(Command.class) & !method.isAnnotationPresent(Parent.class)) {
        final AnnotatedCommand cmd = (AnnotatedCommand) this.parseCommand(object, method, false);
        if (this.parent != null) {
  ...
  @NotNull
  @Override
  public ICommand parseCommand(@NotNull Object object, @NotNull Method method, boolean isParent) {
  ...
  @Override
  public @NotNull Argument parseArgument(Class parameter, Annotation[] annotations, int position) {
    for (Annotation annotation : annotations) {
