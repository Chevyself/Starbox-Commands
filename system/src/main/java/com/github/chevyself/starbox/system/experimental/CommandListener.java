 ...
 * {@link com.github.chevyself.starbox.system.SystemCommand} in {@link
 * CommandManager#getCommand(String)} if it does it will execute the command and the {@link
 * SystemResult} if it is not empty will be printed in the console
 */
