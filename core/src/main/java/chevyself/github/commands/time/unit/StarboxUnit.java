package chevyself.github.commands.time.unit;
 ...
 *
 * <p>The direct implementation to use in {@link Time} is {@link Unit} but classes implementing this
 * interface should represent a unit that is used to measure time.
 */
