 ...
 *
 * <p>To parse {@link AnnotatedCommand} is required to use the annotation {@link Command} if you
 * would like to create an extension the method to override is {@link #execute(CommandContext)}
 */
