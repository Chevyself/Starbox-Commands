 ...
 *
 * <p>To use this middleware you must enter in the {@link
 * me.googas.commands.jda.annotations.Command} map the entry with the key 'permission' and as a
 * value it must be the name of a valid permission in {@link Permission} if the command is executed
 * outside a {@link net.dv8tion.jda.api.entities.Guild} an error message will be displayed as it
 * will not run
 */
